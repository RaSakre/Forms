          ...
          <div class="hero-section__constructor">
            ...
            <form @submit.prevent="state.id ? editExistingForm() : saveForm()" action="" class="constructor-form">
              ...
              <ButtonConstructor
                ...
                :image="pencil" />
              <ButtonConstructor
                @addQuestion="addQuestion(new MultiRow())"
                :text="'Многострочный ответ'"
                :image="lines" />
              <ButtonConstructor
                @addQuestion="addQuestion(new Radio())"
                :text="'Список одиночного выбора'"
                :image="singleSelect" />
              <ButtonConstructor
                @addQuestion="addQuestion(new Checkbox())"
                :text="'Список множественного выбора'"
                :image="multiSelect" />
              <div class="constructor-actions">
                ...
                <div class="actions-buttons">
                  <Button
                    v-if="state.id"
                    :isLoading="formsStore.isLoading"
                    :variant="'white'"
        ...
        <div class="hero-section__right">
          <div class="hero-section__form-upper">
            <h2 v-if="isNameWritten && state.name !== ''" class="form-title">
              {{ state.name }}
              <img @click="isNameWritten = !isNameWritten" src="@/assets/constructor/constructor-edit.svg" alt="" />
            </h2>
            <h2 v-if="isDescriptionWritten && state.description !== ''" class="form-title">
              {{ state.description }}
              <img
                @click="isDescriptionWritten = !isDescriptionWritten"
                src="@/assets/constructor/constructor-edit.svg"
                alt="" />
            </h2>
            <Input
              v-if="!isNameWritten"
            ...
            <textarea
              v-if="!isDescriptionWritten"
              @blur="handleTextareaBlur"
              v-model="state.description"
              rows="4"
              class="hero-section__form-description"
